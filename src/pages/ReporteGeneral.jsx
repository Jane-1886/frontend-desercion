...
const ReporteGeneral = ({ setVista }) => {
  ...
  const fichas = [
    '2615800', '2621934', '2635721', '2648105',
    '2653749', '2668192', '2674953'
  ];
  ...
  const generarReporte = (ficha) => {
    setVista({ vista: 'ListaAprendices', idFicha: ficha });
    setModalAbierto(null);
  };
      ...
      <div className="form-container derecha">
        ...
        <div className="nuevo-titulo-container">
          <div className="nuevo-titulo">
            Por favor, selecciona las fichas a generar reporte:
          </div>
        </div>
      ...
      {modalAbierto && (
        <div className="modal">
          <div className="modal-content">
            <p>
              ¿Deseas generar el <strong>reporte de asistencia</strong> de los aprendices
              de la ficha <strong>{modalAbierto}</strong>?
            </p>
